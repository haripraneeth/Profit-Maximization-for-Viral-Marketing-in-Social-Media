...
.style18 {color: #F0F0F0; font-weight: bold; }
      ...
      <div class="mainbar">
        <form id="form1" name="form1" method="post" action="">
          <div class="mainbar">
            ...
            <h2 align="center" class="style26">Chart To View Profit based on user  </h2>
			
            <a href="socialmain.jsp" class="style41">Back</a>
            <iframe src="ProfitChart.jsp" height="400" width="600" style="background:#FFFFFF"></iframe>
            <div align="center" class="style51">( Number of Users ) </div>
