...
<head>
<title>purchaseverification</title>
			...
			if(rs.next())
			{
								...
								if(rs1.next()==true)
								{
									...
									//{
											...
											PreparedStatement ps1=connection.prepareStatement("insert into purchase(account_no,user,p_name,price,date)values(?,?,?,?,?)");
														...
														if(k>0)
														{
															...
															String strQuery12 = "delete from cart where (p_name='"+p_Name+"') and user='"+user+"' ";
