    ...
    <div class="content_resize">
      ...
      <div class="mainbar">
        <form id="form1" name="form1" method="post" action="">
          <h3><span class="style39"><span class="style43 style52">User <%=request.getParameter("user")%>'s Profile !!</span></span></h3>
          <p>&nbsp; </p>
          ...
          <table width="539" border="0" cellspacing="2" cellpadding="2">
            <tr>
              <td width="531"><div align="right">
                  <p>&nbsp;</p>
                <p><a href="viewadusers.jsp"><strong>Back</strong></a></p>
              </div></td>
            </tr>
          </table>
        </form>
