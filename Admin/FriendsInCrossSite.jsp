        ...
        <div class="col_allw280 fp_service_box">
          <div class="col_allw280 fp_service_box">
            <table width="423" border="0" cellspacing="2" cellpadding="2">
              <tr>
                <td width="415"><span class="style43">User<span class="style90"> <%=(String)application.getAttribute("user")%></span>'s Friends in Cross Sites!!</span></td>
              </tr>
            </table>
            <p>&nbsp;</p>
            <table width="496" border="2" align="center"  cellpadding="0" cellspacing="0"  ">
              ...
              <tr>
                ...
                <td width="151" height="39" align="center"  valign="middle"><label></label>
                    <form id="form1" name="form1" method="post" action="ufcrossdetails.jsp">
                      <label>
