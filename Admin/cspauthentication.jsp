    ...
    try
		{
			...
			String sql="SELECT * FROM sn where (username='"+username+"' and Password='"+Password+"') and sname='"+site+"'";
			...
			else
			{
				out.print("Invalid Login Details");
				 %><br/><br/><a href="userslogin1.jsp">Back</a><%
			}
	}
	catch(Exception e)
	{
