    ...
    <div class="content_resize">
      ...
      <div class="mainbar">
        <div class="mainbar">
          ...
          <div class="article">
            <h2 align="left" class="style8">Fix Ad </h2>
			<%
			String site =(String)application.getAttribute("site");
			String username =(String)application.getAttribute("csp");
			%>
            <form id="form1" name="form1" method="post" action="fixadamount1.jsp" enctype="multipart/form-data">
              <table width="309">
                <tr>
                  <td width="123" height="46"><span class="style16">Site</span></td>
                  <td width="174"><input type="text" name="site" value="<%=site%>" readonly /></td>
                </tr>
                <tr>
                  <td height="50"><span class="style16">No. Of Months </span></td>
                ...
                <tr>
                  <td height="50"><span class="style16">Price</span></td>
                  <td><input type="text" name="price" /></td>
                </tr>
				  <tr>
                <td><input name="imageField" type="submit"  class="LOGIN" id="imageField" value="Submit" />				</tr>
              </table>
              <p class="style16">&nbsp;</p>
            </form>
            
            <p align="left"><a href="socialmain.jsp" class="style9">Back </a></p>
          </div>
        </div>
      </div>
      <div class="clr"></div>
